...
# opening text:
text.insert(tk.END,
            "Welcome to this demo version of a Q&A Bot!\n"
            " Write any question concerning the range of music activities" 
            "offered by the Leuphana University Lüneburg. \n"
            " Depending on your devices computing power,"
            " the answer generation may take some time, "
            "as everything is happening locally. \n")
...
def ask_ollama(context, question):
    ...
    response = requests.post(
        ...
        json={
            "model": "mistral",
            # finally decided on MistralAI, as it both gave back good results and conforms to european data standards
            "prompt": prompt
        },
